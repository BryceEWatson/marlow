...
module.exports = {
    start: function() {
        ...
        var lassoLessPath = path.join(__dirname, '../../node_modules/lasso-less');
        var lassoMarkoPath = path.join(__dirname, '../../node_modules/lasso-marko');
        require('lasso').configure({
            plugins: [
                lassoLessPath, // Allow Less files to be rendered to CSS
                lassoMarkoPath // Allow Marko templates to be compiled and transported to the browser
            ],
